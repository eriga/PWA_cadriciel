...
<head>
    ...
    <style>
        .st2,html{font-family:sans-serif}.grille li:hover .nombre{background-color:#ccc;box-shadow:initial;border:3px solid #333}.grille li,main{min-height:100%;display:flex}.grille .nombre,body{color:#333;background-color:#eee}html{box-sizing:border-box;line-height:1.5}*,::after,::before{margin:0;padding:0;box-sizing:inherit}body{height:100vh}main{padding-top:3em;flex-direction:column;justify-content:center;align-items:center}main>section{padding:2rem}h1{font-size:2.5rem;text-transform:uppercase;border:5px solid #333;padding:.5em 1em}h2{font-size:1rem;text-align:center}ul{list-style:none}.grille{display:grid;grid-template-columns:1fr;gap:3rem;margin-top:2.5rem;padding:0 5em}.grille li{background-color:#eee;box-shadow:4px 4px 10px #ccc;padding:1.5em 1em;align-items:flex-start;justify-content:center;max-width:350px;position:relative;transition:.1s}.grille li:hover{background-color:#333;color:#eee}.grille code{background-color:#777;color:#eee;padding:.25em .5em;display:inline;font-weight:700}.grille p~p{margin-top:1rem}.grille .nombre{position:absolute;top:-15px;left:-10px;padding:.5em;width:100px;height:40px;margin:0;border:1px solid #ccc;box-shadow:2px 2px 5px #ccc;line-height:1;display:flex;justify-content:center;align-items:center;font-weight:bolder;transition:.1s}.st0{fill:none;stroke:#333333;stroke-width:5;stroke-miterlimit:10}.st1{fill:#333333}.st3{font-size:48.4171px;font-weight:700}.logo{width:50%}.github{position:absolute;top:10px;right:10px}.github a{display:flex;align-items:center;text-decoration:none}.github svg{width:35px;height:35px;fill:#333}.github span{margin-left:5px;display:none;color:#333}@media screen and (min-width:768px){.grille{grid-template-columns:repeat(2,1fr);grid-template-rows:repeat(2,1fr);gap:3rem}h2{font-size:1.5rem}.github{right:30px}.github span{display:inline}}@media screen and (min-width:1300px){.grille{grid-template-columns:1fr 1fr 1fr 1fr;grid-template-rows:1fr}.logo{width:35%}}
    </style>
</head>
